 ...
 *
 * Numbering and the 280-char boundary live in threadShape.ts — the pipeline
 * needs those server-side too. Re-exported here so the editor keeps one import.
 */
import { renumber } from './threadShape';

export { renumber, canSplit, splitTweet } from './threadShape';
