  ...
  return (
    <section className="w-full max-w-md flex flex-col gap-4">
      ...
      <button
        ...
        className="self-center inline-flex items-center justify-center gap-1.5 min-h-11 px-2 rounded font-mono text-[11px] text-muted-foreground hover:text-primary active:bg-primary/10 transition-colors disabled:opacity-50 md:min-h-9"
      >
