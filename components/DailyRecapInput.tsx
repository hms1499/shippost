    ...
    <section className="w-full max-w-md flex flex-col gap-4">
      {onBack && (
        <button
          ...
          className="self-start flex items-center gap-1.5 min-h-11 px-1 -mx-1 rounded heading-sub text-[10px] no-underline hover:text-primary active:bg-primary/10 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
